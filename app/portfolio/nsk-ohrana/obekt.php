...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['formid']) && $_POST['formid'] == 'form1')
{
   ...
   $subject = 'Objekti nsk-ohrana.ru';
   $message = '';
   $success_url = './ok-obekt.php';
   $error_url = '';
   $error = '';
   $eol = "\n";
      ...
      <div id="wb_Form1">
         <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" target="_self" id="Form1">
            ...
            <div id="wb_indexText63">
               <span id="wb_uid0"><strong>ОХРАНА <br>ОБЪЕКТОВ</strong></span></div>
            <div id="wb_indexShape29">
               <img src="images/img0007.png" id="indexShape29" alt=""></div>
            <div id="wb_Text3">
               <span id="wb_uid1">Предоставляем комплекс мероприятий по оценке технической защищенности объекта и мер, направленных на обеспечение безопасности, функционирования объекта, его материального имущества, защиту жизни, здоровья его персонала.</span></div>
            <div id="wb_callbackText2">
               <span id="wb_uid2">Тел.:</span></div>
            <div id="wb_callbackText1">
               <span id="wb_uid3">Имя:</span></div>
            ...
            <div id="wb_indexText37">
               <span id="wb_uid4"><strong>ЗАКАЗАТЬ УСЛУГУ</strong></span></div>
...
<link href="css/obekt.css" rel="stylesheet">
