...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['formid']) && $_POST['formid'] == 'form1')
{
   ...
   $subject = 'Pojharka nsk-ohrana.ru';
   $message = '';
   $success_url = './ok-pozh_signal.php';
   $error_url = '';
   $error = '';
   $eol = "\n";
      ...
      <div id="wb_Form1">
         <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" target="_self" id="Form1">
            ...
            <div id="wb_indexText63">
               <span id="wb_uid0"><strong>ПОЖАРНО - ОХРАННАЯ СИГНАЛИЗАЦИЯ</strong></span></div>
            <div id="wb_indexShape29">
               <img src="images/img0133.png" id="indexShape29" alt=""></div>
            <div id="wb_Text3">
               <span id="wb_uid1">Установим пожарную сигнализацию, поможем получить разрешение у контролирующих органов, составить необходимые документы</span></div>
...
<link href="css/pozh_signal.css" rel="stylesheet">
