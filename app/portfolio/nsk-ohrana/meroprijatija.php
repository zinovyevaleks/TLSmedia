...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['formid']) && $_POST['formid'] == 'form1')
{
   ...
   $subject = 'Meroprijatie nsk-ohrana.ru';
   $message = '';
   $success_url = './ok-meroprijatija.php';
   $error_url = '';
   $error = '';
   $eol = "\n";
      ...
      <div id="wb_Form1">
         <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" target="_self" id="Form1">
            ...
            <div id="wb_indexText63">
               <span id="wb_uid0"><strong>БЕЗОПАСНОСТЬ НА МЕРОПРИЯТИЯХ</strong></span><span id="wb_uid1"><strong><br><br></strong></span></div>
            <div id="wb_indexShape29">
               <img src="images/img0011.png" id="indexShape29" alt=""></div>
            <div id="wb_Text3">
               <span id="wb_uid2">Обеспечиваем безопасность при проведении массовых мероприятий, праздников, юбилеев, торжеств ит.д. Обеспечиваем безопасность при проведении группового отдыха за городом.</span></div>
...
<link href="css/meroprijatija.css" rel="stylesheet">
