...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['formid']) && $_POST['formid'] == 'form1')
{
   ...
   $subject = 'Specpredlojenie nsk-ohrana.ru';
   $message = '';
   $success_url = './ok-specpred.php';
   $error_url = '';
   $error = '';
   $eol = "\n";
   ...
   <div id="container">
      <div id="wb_Form1">
         <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" target="_self" id="Form1">
            ...
            <div id="wb_Text2">
               <span id="wb_uid0"><strong>СПЕЦИАЛЬНОЕ ПРЕДЛОЖЕНИЕ</strong></span></div>
            ...
            <input type="number" id="Editbox1" name="тел" value="" autocomplete="off" spellcheck="false" placeholder=" &#1042;&#1074;&#1077;&#1076;&#1080;&#1090;&#1077; &#1090;&#1077;&#1083;">
...
<link href="css/specpred.css" rel="stylesheet">
