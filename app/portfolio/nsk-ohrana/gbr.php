...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['formid']) && $_POST['formid'] == 'form1')
{
   ...
   $subject = 'GBR nsk-ohrana.ru';
   $message = '';
   $success_url = './ok-gbr.php';
   $error_url = '';
   $error = '';
   $eol = "\n";
      ...
      <div id="wb_Form1">
         <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" target="_self" id="Form1">
            ...
            <div id="wb_indexText63">
               <span id="wb_uid0"><strong>ГРУППА БЫСТРОГО РЕАГИРОВАНИЯ</strong></span><span id="wb_uid1"><strong><br></strong></span></div>
            <div id="wb_indexShape29">
               <img src="images/img0002.png" id="indexShape29" alt=""></div>
            <div id="wb_Text3">
               <span id="wb_uid2">Мобильные группы, сформированные из наиболее подготовленных и экипированных сотрудников, которые при поступлении сигнала тревоги осуществляют срочный выезд по полученному сигналу и предпринимают необходимые действия</span></div>
            <div id="wb_callbackText2">
               <span id="wb_uid3">Тел.:</span></div>
            <div id="wb_callbackText1">
               <span id="wb_uid4">Имя:</span></div>
            <input type="text" id="Editbox4" name="Имя" value="" autocomplete="off" spellcheck="false" required="" placeholder=" &#1042;&#1074;&#1077;&#1076;&#1080;&#1090;&#1077; &#1080;&#1084;&#1103;">
            <input type="text" id="Editbox1" name="тел" value="" autocomplete="off" spellcheck="false" required="" pattern="[0-9-]*$" placeholder=" &#1042;&#1074;&#1077;&#1076;&#1080;&#1090;&#1077; &#1090;&#1077;&#1083;">
            ...
            <div id="wb_indexText37">
               <span id="wb_uid5"><strong>ЗАКАЗАТЬ УСЛУГУ</strong></span></div>
            <button type="submit" id="indexjQueryButton3" onmouseover="ShowObject('wb_indexImage31', 0);return false;" onmouseout="ShowObject('wb_indexImage31', 1);return false;" name="" value="Получить расчет">Получить расчет</button>
         </form>
      </div>
   </div>
<!-- Yandex.Metrika counter -->
   ...
   <noscript><div><img src="https://mc.yandex.ru/watch/35205560" id="wb_uid6" alt=""/></div></noscript>
...
<!-- Rating@Mail.ru counter -->
   ...
   </script><noscript><div id="wb_uid7">
...
<!-- VKONTAKTE code --><link href="css/Copy of le-frog/jquery-ui.min.css" rel="stylesheet">
...
<link href="css/gbr.css" rel="stylesheet">
