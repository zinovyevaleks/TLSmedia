...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['formid']) && $_POST['formid'] == 'form1')
{
   ...
   $subject = 'vopros nsk-ohrana.ru';
   $message = '';
   $success_url = './ok-vopros.php';
   $error_url = '';
   $error = '';
   $eol = "\n";
      ...
      <div id="wb_Form1">
         <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" target="_self" id="Form1">
            ...
            <div id="wb_callbackText1">
               <span id="wb_uid0">Имя:</span></div>
            <div id="wb_callbackText2">
               <span id="wb_uid1">Тел.:</span></div>
            <div id="wb_Text2">
               <span id="wb_uid2"><strong>ЗАДАТЬ ВОПРОС</strong></span></div>
            <div id="wb_Text1">
               <span id="wb_uid3">Оставьте заявку и наш специалист перезвонит вам и ответит на все ваши вопросы</span></div>
            <div id="wb_voprosText1">
               <span id="wb_uid4"> Вопрос:</span></div>
            <textarea name="вопрос" id="TextArea1" rows="4" cols="25" spellcheck="false" required="" placeholder=" &#1042;&#1074;&#1077;&#1076;&#1080;&#1090;&#1077; &#1074;&#1086;&#1087;&#1088;&#1086;&#1089;"></textarea>
            ...
            <div id="wb_indexText37">
               <span id="wb_uid5"><strong>ЗАКАЗАТЬ ЗВОНОК</strong></span></div>
...
<link href="css/vopros.css" rel="stylesheet">
